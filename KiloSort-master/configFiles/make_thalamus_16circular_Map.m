function make_thalamus_16circular_Map(fpath)
...
xcoords = [-250 -176.8 0 176.8 500 353.6 0 -353.6 -176.8 0 176.8 250 353.6 0 -353.6 -500];
ycoords = [0 176.8 250 176.8 0 -353.6 -500 -353.6 -176.8 -250 -176.8 0 353.6 500 353.6 0];
...
save(fullfile(fpath, 'thalamus_16circular_Map.mat'), 'chanMap', 'connected', 'xcoords', 'ycoords', 'kcoords', 'fs')