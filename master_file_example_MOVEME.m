...
addpath(genpath('G:\Dropbox (Frohlich Lab)\Frohlich Lab Team Folder\Codebase\CodeStefano\KiloSort')) % path to kilosort folder
addpath(genpath('G:\Dropbox (Frohlich Lab)\Frohlich Lab Team Folder\Codebase\CodeStefano\KiloSort\npy-matlab-master')) % path to npy-matlab scripts
